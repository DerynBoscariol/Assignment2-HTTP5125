...
namespace HTTP5125_A2.Controllers
{
    ...
    {   //J2 - Sounds Fishy!
        ...
        ///<summary>
        ///This method recieves consecutive depths and determines whether there
        ///is a fish rising,a fish diving, a constant depth or no fish based on
        ///whether the inputs are increasing, decreasing remaianing the same, or
        ///not showing a consistent trend
        /// </summary>
        ...
        /// <returns>A string reading "Fish Rising", "Fish Diving", "Constant Depth",
        ...
        public string DetectFish(int a, int b, int c, int d)
        {
            ...
            //If the inputs don't have a consistant trend, the method will return No Fish
            else
            {
                return "No Fish";
            }
